		...
		for ( var pos = 0, numli = li.length; pos < numli; pos++ ) {
			...
			if ( create || !item.hasClass( "ui-li" ) ) {
				...
				if ( a.length && !isDivider ) {
					...
					if ( a.first().jqmData("role") != "splitbutton" ) {
					  item.buttonMarkup({
  						wrapperEls: "div",
  						shadow: false,
  						corners: false,
          ...
          if ( a.first().jqmData("role") != "splitbutton" ) {
					...
					if ( a.length > 1 || a.first().jqmData("role") == "splitbutton" ) {
...
$.mobile.listview.prototype.options.filterInputType = "text";
...
$( document ).delegate( ":jqmData(role='listview')", "listviewcreate", function() {
	...
	var wrapper = $( "<form>", {
		...
		search = $( "<input>", {
			...
			type: list.jqmData( "filter-input-type" ) || $.mobile.listview.prototype.options.filterInputType,
		})

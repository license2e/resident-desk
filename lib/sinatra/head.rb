...
module Sinatra
  module Head
    ...
    def inherited(child)
      ...
      child.set :title, settings.title.clone
      child.set :stylesheets, settings.stylesheets.clone
      child.set :javascripts, settings.javascripts.clone
    end
